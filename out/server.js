...
connection.onDidChangeConfiguration(change => {
    if (hasConfigurationCapability) {
        ...
        globalSettings = ((change.settings.languageServerMorph || defaultSettings));
    }
...
function validateMorphDocument(morphDocument) {
    return __awaiter(this, void 0, void 0, function* () {
        // In this simple example we get the settings for every validate run.
        let settings = yield getDocumentSettings(morphDocument.uri);
        // The validator creates diagnostics for all uppercase words length 2 and more
        const text = morphDocument.getText();
        const parsed = Parser_1.Parser.parse(text);
